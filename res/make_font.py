...
sep_surface = pygame.Surface((3, max_char_h), pygame.SRCALPHA);
sep_surface.fill((0,0,0,0))
sep_surface.set_at((0,0),(0,255,0,255));
sep_surface.set_at((1,0),(255,0,255,255));
sep_surface.set_at((2,0),(0,255,0,255));
...
font_surface.set_at((0,0),(255,0,255,255))
font_surface.set_at((1,0),(0,255,0,255));
font_surface.set_at((2,0),(0,0,0,0));
