...
uint32_t KEYMAP_X = SDL_SCANCODE_A;
uint32_t KEYMAP_Y = SDL_SCANCODE_S;

uint32_t KEYMAP_LB = SDL_SCANCODE_Q;
uint32_t KEYMAP_RB =   SDL_SCANCODE_W;
uint32_t KEYMAP_LT =   SDL_SCANCODE_1;
uint32_t KEYMAP_RT =   SDL_SCANCODE_2;
	
uint32_t KEYMAP_LS =   SDL_SCANCODE_Z;
uint32_t KEYMAP_RS =   SDL_SCANCODE_C;
